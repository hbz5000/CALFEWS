...
path_model=r"C:/Users/km663/Documents/Models/CALFEWs_Git/ORCA_COMBINED/"
os.chdir(path_model) 
...
def main_CALFEW(i_N): #Keyvan


    import numpy as np
    import pandas as pd
    import matplotlib.pyplot as plt
    #import cord #keyvan commented these lines 
    #from cord import *
    ...
    if model_mode == 'sensitivity':
      ...
      new_inputs = Inputter(base_data_file, expected_release_datafile, model_mode, i_N, parallel_mode, use_sensitivity = True)
      ...
      for x in range(0, total_sensitivity_factors):
        ...
        if parallel_mode == True:
            input_data_file="cord/data/input/temp_output/cord-data-CDEC_19962016_" + str(i_N) + ".csv" #keyvan
        else:
      ...
      param_df.to_csv(results_folder + '/sens_out/sens_param_scr_' + str(i_N) + '.csv') #keyvan
      sensitivity_df.to_csv(results_folder + '/sens_out/sens_results_scr_'+ str(i_N) + '.csv') #keyvan
    ######################################################################################
...
#----------------------------------------------------------------------------------
#---------------------- main_CALFEW function ends here ----------------------------------
#----------------------------------------------------------------------------------------------
