...
df <- read.csv(file=paste('C:/Users/Andrew/PycharmProjects/ORCA_COMBINED/cord/data/results/',folder1,'/district_reorg.csv', sep=''), header=TRUE, sep=",", stringsAsFactors = F)
