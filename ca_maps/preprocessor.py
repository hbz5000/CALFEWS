...
def create_shape_lists(map_type, use_type):
  ...
  if map_type == 'total':
    ...
    if use_type in ['friant', 'alt1', 'intro-tulare', '1827_median_FKC_CFWB', '537_median_FKC_CFWB', '2454_median_FKC_CFWB', '981_median_FKC_CFWB']:
      ...
      calfews_attributes['shapefiles'] = ['drawings-line', 'Tulare_Basin-line', 'San_Joaquin-line', 'kings_ext', 'districts_FKC_experiment_sagbi', '../../../../../../Downloads/SAGBI-20210914T194833Z-001/SAGBI/sagbi_mod/sagbi_mod_clip']
