...
grep label $results/objs_wcu.csv >> $results/objs_wcu_pareto_8objs.csv
python3 ../pareto.py $results/objs_wcu.csv -o 44-51 -m 44-46 48 -e 2. 2. 2. 5. 0.999 5. 5. 5. --output dum.csv --delimiter=", " --comment="#" --header=1
cat dum.csv >> $results/objs_wcu_pareto_8objs.csv
