### Second step in making maps from paper. This should be run once with "boxplot_combined" as argv, and once with "sagbi".
...
figure_type = 'FKC_exp'
use_type = sys.argv[1]  ### FKC_exp use_types- boxplot_combined, sagbi
...
plt.savefig('../figures/' + figure_type + '_' + use_type + '_300.png', dpi = 300, bbox_inches = 'tight', pad_inches = 0.0)
plt.show()
