...
### run baseline without FKC or CFWB, if argv1 == 1
if rerun_baselines == 1:
  ...
  ### scenario with FKC-only, with all Friant districts having equal shares
  ...
  ### scenario with FKC-only, ownership based on historical friant allocations ("Friant-16" partnership in paper)
