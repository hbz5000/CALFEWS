...
for figmode in ['past','future']:
    ...
    axs[0].text(0.05, 0.90, "a)", fontsize=fontsize+1, weight="bold", transform=axs[0].transAxes)
    axs[1].text(0.05, 0.90, "b)", fontsize=fontsize+1, weight="bold",transform=axs[1].transAxes)
    axs[2].text(0.05, 0.90, "c)", fontsize=fontsize+1, weight="bold", transform=axs[2].transAxes)
