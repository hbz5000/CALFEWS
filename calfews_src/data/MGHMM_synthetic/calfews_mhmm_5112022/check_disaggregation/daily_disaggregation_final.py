...
calfews_data=pd.read_csv("./inputs/calfews_src-data-sim-agg_norm.csv")
...
AnnualQ_s=pd.read_csv("outputs/AnnualQ_s.csv",header=None)
AnnualQ_h=pd.read_csv("inputs/AnnualQ_h.csv",header=None)
...
DailyQ_s.to_csv('./outputs/DailyQ_s_pytest.csv', index=False)



#Test if the same: 
r_data=pd.read_csv("./outputs/DailyQ_s.csv")
assert_frame_equal(DailyQ_s, r_data, check_less_precise=True)
