...
#define __PYX_HAVE__calfews_src____init__
#define __PYX_HAVE_API__calfews_src____init__
/* Early includes */
#ifdef _OPENMP
#include <omp.h>
#endif /* _OPENMP */
...
/* Module declarations from 'calfews_src.__init__' */
...
/* Implementation of 'calfews_src.__init__' */
static const char __pyx_k_main[] = "__main__";
static const char __pyx_k_name[] = "__name__";
static const char __pyx_k_test[] = "__test__";
static const char __pyx_k_calfews_src[] = "calfews_src";
static const char __pyx_k_cline_in_traceback[] = "cline_in_traceback";
static PyObject *__pyx_n_u_calfews_src;
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  {&__pyx_n_u_calfews_src, __pyx_k_calfews_src, sizeof(__pyx_k_calfews_src), 0, 1, 0, 1},
...
if (!__Pyx_RefNanny) {
  ...
  if (!CYTHON_PEP489_MULTI_PHASE_INIT) {
    if (unlikely(__Pyx_SetPackagePathFromImportLib(NULL, __pyx_n_u_calfews_src) < 0)) __PYX_ERR(0, 2, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init calfews_src.__init__", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init calfews_src.__init__");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
