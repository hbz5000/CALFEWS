...
# observations = pd.read_csv('calfews_src/data/input/calfews_src-data.csv', index_col=0, parse_dates=True)
# simulated_calfews_src_data = pd.read_csv('calfews_src/data/input/calfews_src-data-sim.csv', index_col=0, parse_dates=True)
#
# plt.plot(np.log(observations.MIL_inf), color='k', lw=3)
# plt.plot(np.log(simulated_calfews_src_data.MIL_inf), color = 'indianred', alpha=0.7, lw=3)
# plt.ylabel('Daily flow, ln(cfs)')
# plt.title('MIL-inflow')
#
# plt.plot(np.log(observations.PFT_inf), color='k', lw=3)
# plt.plot(np.log(simulated_calfews_src_data.PFT_inf), color = 'indianred', alpha=0.7, lw=3)
# plt.ylabel('Daily flow, ln(cfs)')
# plt.title('PFT-inflow')
#
# plt.plot(np.log(observations.KWH_inf), color='k', lw=3)
# plt.plot(np.log(simulated_calfews_src_data.KWH_inf), color = 'indianred', alpha=0.7, lw=3)
# plt.ylabel('Daily flow, ln(cfs)')
# plt.title('KWH-inflow')
#
# plt.plot(np.log(observations.SUC_inf), color='k', lw=3)
# plt.plot(np.log(simulated_calfews_src_data.SUC_inf), color = 'indianred', alpha=0.7, lw=3)
# plt.ylabel('Daily flow, ln(cfs)')
# plt.title('SUC-inflow')
#
# plt.plot(np.log(observations.ISB_inf), color='k', lw=3)
# plt.plot(np.log(simulated_calfews_src_data.ISB_inf), color = 'indianred', alpha=0.7, lw=3)
# plt.ylabel('Daily flow, ln(cfs)')
...
canal1, canal_aggregate_Wateryear1, canal_aggregate_Wateryear_Month1, ind_canal_waterway1, ind_canal_recipient1, ind_canal_flowtype1 = \
            load_model_data.load_canal_data('calfews_src/data/results/FKC_capacity_wy2017/canal_results_simulation.csv')
canal2, canal_aggregate_Wateryear2, canal_aggregate_Wateryear_Month2, ind_canal_waterway2, ind_canal_recipient2, ind_canal_flowtype2 = \
            load_model_data.load_canal_data('calfews_src/data/results/FKC_capacity_rehab_full/canal_results_simulation.csv')
canal3, canal_aggregate_Wateryear3, canal_aggregate_Wateryear_Month3, ind_canal_waterway3, ind_canal_recipient3, ind_canal_flowtype3 = \
            load_model_data.load_canal_data('calfews_src/data/results/FKC_capacity_wy2017__LWT_inleiubank_DLESSJSFW_0/canal_results_simulation.csv')
canal4, canal_aggregate_Wateryear4, canal_aggregate_Wateryear_Month4, ind_canal_waterway4, ind_canal_recipient4, ind_canal_flowtype4 = \
            load_model_data.load_canal_data('calfews_src/data/results/FKC_capacity_rehab_full__LWT_inleiubank_DLESSJSFW_0/canal_results_simulation.csv')

# folder_name = 'FKC_capacity_wy2017'
# os.makedirs('calfews_src/figs/flowDiagrams/' + folder_name, exist_ok=True)
...
# folder = 'FKC_capacity_wy2017__LWT_inleiubank_ARV_0'
  ...
  district_modeled_aggregate_Wateryear, district_modeled_aggregate_Wateryear_Month, friant_districts, source_modeled, districts_modeled, WT_modeled = \
    load_model_data.load_district_data('calfews_src/data/results/'+folder+'/district_results_full_simulation.csv')

  leiu_modeled_aggregate_Wateryear, leiu_modeled_aggregate_Wateryear_Month, leiu_banker_modeled, leiu_bankee_modeled = \
    load_model_data.load_leiu_data('calfews_src/data/results/'+folder+'/leiu_results_simulation.csv')

  bank_modeled_aggregate_Wateryear, bank_modeled_aggregate_Wateryear_Month, bank_banker_modeled, bank_bankee_modeled = \
    load_model_data.load_bank_data('calfews_src/data/results/'+folder+'/bank_results_simulation.csv')
  ...
  #   recharged -= error
  #
  #   # now recalfews_src data. need to fill in sources & uses in equal volumes to have one observation per alluvium for Sankey plot. Doesn't need to correspond to actual relationship between sources and uses.
  ...
  # df_reorg.to_csv('calfews_src/data/results/'+folder+'/district_reorg.csv', index=False)
